...
# 1510 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\pic18_chip_select.inc" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\proc\\pic18f87k22.inc" 1 3
# 48 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\proc\\pic18f87k22.inc" 3
PMD3 equ 0F16h
...
TOSU equ 0FFFh
# 12494 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\proc\\pic18f87k22.inc" 3
...
# 1510 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\pic18_chip_select.inc" 2 3
...
RTCC_Setup:
    banksel RTCCFG ; ((PORTG) and 0FFh), 4, a SFRs are not in access ram
    bsf ((PADCFG1) and 0FFh), 2, b ; RTSECSELx bits determine output on ((PORTG) and 0FFh), 4, a pin
    bcf ((PADCFG1) and 0FFh), 1, b ; 10 outputs the source clock, 01 outputs second count
    movlw 0x84 ; Enable ((PORTG) and 0FFh), 4, a, turn on ((PORTG) and 0FFh), 4, a output pin
    movwf RTCCFG, B
...
RTCC_Get_Seconds: ; Reads and stores seconds value in RTCC_Seconds
   ; Also returns the value in W register
    banksel RTCCFG ; ((PORTG) and 0FFh), 4, a SFRs are not in access ram
    bcf ((RTCCFG) and 0FFh), 1, b ; Clear ((RTCCFG) and 0FFh), 1, b and ((RTCCFG) and 0FFh), 0, b for seconds output
    bcf ((RTCCFG) and 0FFh), 0, b
